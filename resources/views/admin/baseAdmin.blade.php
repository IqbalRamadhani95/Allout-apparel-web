        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    ...
                    <img src="/images/ao3.png" class="img-admin" alt="">
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/product_admin">
        ...
        <script>
            $('.delete').click(function() {
                ...
                Swal.fire({
                    ...
                    text: "Anda akan menghapus data product",
                    type: 'warning',
                    ...
                    if (result.value) {
                        window.location = "/product_admin/delete/" + product_id + ""
                        Swal.fire(
                            'Terhapus!',
